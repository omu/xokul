...
module Yoksis
  module Resumes
    class ProjectsSerializer < Serializer
      ...
      attribute(:status_name)            { object[:proje_durumu_ad]                         }
      ...
      attribute(:location_name)          { object[:proje_konumu_ad]                         }
      attribute(:type_id)                { object[:proje_turu_id].safe_to_i                 }
      attribute(:type_name)              { object[:proje_turu_ad]                           }
      attribute(:currency_id)            { object[:para_birimi_id].safe_to_i                }
      attribute(:currency_name)          { object[:para_birimi_ad]                          }
