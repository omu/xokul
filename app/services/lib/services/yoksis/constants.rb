...
module Services
  module Yoksis
    ...
    class References < Base
      ...
      ARGS = {
        academic_years: reference_parameters.merge(code: 31),
        ...
        course_statuses: reference_parameters.merge(code: 33),
        course_terms: reference_parameters.merge(code: 35),
        credit_types: reference_parameters.merge(code: 38),
        final_statuses: reference_parameters.merge(code: 37),
        ...
        terms: reference_parameters.merge(code: 36),
        ...
        yoksis_countries: reference_parameters.merge(code: 28),
        districts: {
