...
module RestClient
    ...
    class Request
      def initialize(method, url, header = {}, **http_options)
        ...
        raise HTTPMethodError, "Unsupported HTTP method: :#{method}" unless SUPPORTED_HTTP_METHODS.include?(method)
      ...
      def build_http_object(http_options)
        ...
        raise HTTPOptionError, "Unsupported HTTP options: #{unsupported_opts}" unless unsupported_opts.empty?
